...
- A previous release introduced an issue that could cause unnecessary calls for every query. This issue has been resolved and could result in improved query performance.
