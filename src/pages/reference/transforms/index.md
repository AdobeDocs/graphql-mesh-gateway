...
[encapsulate] | `0.3.35`
[federation] | `0.8.35`
[filterSchema] | `0.14.35`
[namingConvention] | `0.10.25`
[prefix] | `0.11.24`
[rename] | `0.12.37`
[replaceField] | `0.3.34`
[typeMerging] | `0.3.23`

See [Transforms] if you would like more information on transforms in the context of the API Mesh.
...
"Wrap" mode adds significant overhead and can cause longer processing times. When using the API Mesh, we strongly recommend using [Bare](index.md#bare) mode.
