...
The following table specifies the transforms supported by API Mesh for Adobe Developer App Builder and the version of each transform:
...
See [Transforms] if you would like more information on transforms in the context of API Mesh for Adobe Developer App Builder.
...
"Wrap" mode adds significant overhead and can cause longer processing times. When using API Mesh for Adobe Developer App Builder, we strongly recommend using [Bare](###Bare) mode.
