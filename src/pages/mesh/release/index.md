...
API Mesh now supports HIPAA compliance. To create a mesh that contains Protected Health Information (PHI), refer to [HIPAA Compliance](../basic/work-with-mesh.md#hipaa-compliance).
