...
1. Use the arrow keys to select the `stage` Workspace and click **Enter**. Type `y` and press the **Enter** key to automatically select this Workspace in the future. You can [select another workspace](../basic/work-with-mesh.md#select-a-project-or-workspace) at any time.
...
1. Run the [`aio api-mesh:describe`](../advanced/index.md#aio-api-meshdescribe) command and copy the URL for your mesh.
...
1. Determine if you can view the schema in the **Docs** section of your GraphQL client. Refer to your GraphQL client's documentation to learn how to access the schema.
    ...
    - Check your mesh's sources. If you need to modify your mesh, use the [`aio api-mesh:update`](../advanced/index.md#aio-api-meshupdate) command to update your mesh with the correct information.
...
You can use the [source commands](../advanced/index.md#aio-api-meshsourceinstall) to install preconfigured first and third-party sources. You can find available sources by running the `aio api-mesh:source:discover` command or visiting the Adobe [api-mesh-sources](https://github.com/adobe/api-mesh-sources) repo.
